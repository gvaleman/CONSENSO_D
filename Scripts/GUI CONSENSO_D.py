...
class ConsensoGUI:
    ...
    def crear_panel_ensamblaje(self):
        ...
        # Título
        titulo = tk.Label(self.panel_ensamblaje, text="🧬 ENSAMBLAJE DE GENOMAS VIRALES", font=("Helvetica", 16, "bold"), bg="white", fg="#2c3e50")
        titulo.pack(pady=20)
    ...
    def crear_panel_variantes(self):
        ...
        titulo = tk.Label(self.panel_variantes, text="🧪 LLAMADO DE VARIANTES", font=("Helvetica", 16, "bold"), bg="white", fg="#e74c3c")
        titulo.pack(pady=20)
    ...
    def crear_panel_lineajes(self):
        ...
        titulo = tk.Label(self.panel_lineajes, text="🌳 VIRAL-BRANCH (LINAJES)", font=("Helvetica", 16, "bold"), bg="white", fg="#27ae60")
        titulo.pack(pady=20)
    ...
    def crear_panel_otras_funciones(self):
        ...
        titulo = tk.Label(self.panel_otras, text="🔧 OTRAS FUNCIONES", font=("Helvetica", 16, "bold"), bg="white", fg="#9b59b6")
        titulo.pack(pady=20)
